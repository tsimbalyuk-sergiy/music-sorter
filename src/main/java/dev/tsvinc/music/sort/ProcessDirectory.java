...
//import static dev.tsvinc.music.sort.Constants.FLAC_GLOB;
//import static dev.tsvinc.music.sort.Constants.MP3;
//import static dev.tsvinc.music.sort.Constants.MP3_GLOB;
//import static dev.tsvinc.music.sort.Constants.UNKNOWN;
//
//public class ProcessDirectory {
//
////  private static final Logger log = LoggerFactory.getLogger(ProcessDirectory.class.getSimpleName());
//
...
//    listFiles(folderName, resultMp3, MP3_GLOB);
//    listFiles(folderName, resultFlac, FLAC_GLOB);
//    if (!resultMp3.isEmpty()) {
//      result = ListingWithFormat.builder().format(MP3).fileList(resultMp3).build();
//    } else if (!resultFlac.isEmpty()) {
//      result = ListingWithFormat.builder().format(FLAC).fileList(resultFlac).build();
//    }
//    return result;
//  }
//
